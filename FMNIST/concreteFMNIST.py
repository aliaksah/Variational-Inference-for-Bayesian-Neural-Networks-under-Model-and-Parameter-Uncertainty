...
for i in range(9,10):
    ...
    enr = outofsample(net)
    np.savetxt(X=enr, fname="entroConcretefmmm" + str(i) + ".csv", delimiter=",")
    torch.save(net.state_dict(), "FfmmmConcrete" + str(i) + ".par")
    # pepochs = 1
    ...
    enr = outofsample(net)
    np.savetxt(X=enr, fname="pentroConcretefmmm" + str(i) + ".csv", delimiter=",")
    torch.save(net.state_dict(), "FfmmmpConcrete" + str(i) + ".par")
