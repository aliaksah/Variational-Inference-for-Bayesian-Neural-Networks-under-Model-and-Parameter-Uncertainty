...
for i in range(9,10):
    ...
    torch.save(net.state_dict(), "horseffmreduced" + str(i) + ".par")
    enr = outofsample(net)
    np.savetxt(X=enr, fname="entrohorseprunedfmm" + str(i) + ".csv", delimiter=",")
    np.savetxt("fmnisthorseprunded_" + str(i) + ".csv", res, delimiter=",")
    ...
    enr = outofsample(net)
    np.savetxt(X=enr, fname="entrohorseprunedpostfmm" + str(i) + ".csv", delimiter=",")
    np.savetxt("fmnisthorseprundedpost_" + str(i) + ".csv", res, delimiter=",")
