...
for i in range(9,10):
    ...
    enr = outofsample(net)
    np.savetxt(X=enr, fname="entromixgaussmm" + str(i) + ".csv", delimiter=",")
    torch.save(net.state_dict(), "mixgaussfm" + str(i) + ".par")

    np.savetxt("mixgaussmaccuracies_" + str(i) + ".csv", res, delimiter=",")
