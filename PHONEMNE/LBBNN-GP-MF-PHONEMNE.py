...
for i in range(0, 10):
    ...
    np.savetxt("beta_gammamaccuracies_" + prefix + str(i) + ".csv", res, delimiter=",")
    ...
    res = test_ensemble(net)
    np.savetxt("ptbeta_gammammaccuracies_"+ prefix + str(i) + ".csv", res, delimiter=",")
    torch.save(net.state_dict(), "beta_gammafmp"+prefix+ str(i) + ".par")